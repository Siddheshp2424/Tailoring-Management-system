                     ...
                     if(rs.next() == false) {
                    	...
                    	do{	 
                    	 ...
                    	 <tr  class="danger" style="color:black">
		                  ...
		                  <%}%>
                    	 <TR>
                    	 <td><img alt="Profile Pic" class="img-circle" src="TailorDesignPic.jsp?id=<%=rs.getInt(1) %>"  width="80px" height="80px"/></td>
                    	                     	 
                    	  <td style="color:black"><%=rs.getString(4) %></td> 
                    	 <td style="color:black"><%=rs.getString(5) %></td>
                    	 <td style="color:black"><%=rs.getString(6) %></td>
                    	 <td><a style="color:red;" href="DeleteTailorDesignCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	</TR>                    	 
                    <%count++; }while(rs.next());}%> 
       ...
       <%-- 
                  ...
                  <%--    if(rs.next() == false) {
                    	...
                    	do{	 
                    	 ...
                    	 <td style="color:black"><%=rs.getString(5) %></td>
                    	 <td style="color:black"><%=rs.getString(6) %></td>
                    	 <td><a style="color:red;" href="DeleteTailorCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	 </TR>                    	 
                     <%count++; }while(rs.next());}%> 
