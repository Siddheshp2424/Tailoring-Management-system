             ...
             <form class="subscription-form">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     Statement st=con.createStatement();
                       ...
                       ResultSet rs=st.executeQuery("select addorder.id,user.name,user.address,user.mobileno,user.email,addorder.dressname,addorder.status,addorder.statuss from addorder inner join user on addorder.name=user.name");
