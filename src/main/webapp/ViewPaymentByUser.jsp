...
<body>
    ...
    <div class="container d-flex justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="ViewDesignsByTailor.jsp">View Designs</a></li>
  ...
  <br><br>
    ...
    <div class="row">
                    ...
                    /*  ResultSet rs=st.executeQuery("select * from adddesignbytailor email='"+email+"'"); */
                    /*  ResultSet rs=st.executeQuery("select * from payment"); */
                     ResultSet rs=st.executeQuery("select payment.id,payment.name,payment.email,addorder.dressname,addorder.price,payment.status from payment inner join addorder on payment.name=addorder.name");
                     ...
                     if(rs.next() == false) {
                    	...
                    	do{	 
                    	 ...
                    	 <td><a style="color:red;" href="DeletePaymentByUserCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	</TR>                    	 
                    <%count++; }while(rs.next());}%> 
