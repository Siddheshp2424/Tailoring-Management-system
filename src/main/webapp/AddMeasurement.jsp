      ...
      <div class="container">
        ...
        <%
            ...
            <div class="single-team-member">
          	...
          	<% 
                ...
                String fabricname=request.getParameter("fabricname");
                	Connection con=DBConnection.getConnection();
                    Statement st=con.createStatement();
                     ResultSet rs=st.executeQuery("select * from addfabric where fabricname='"+fabricname+"'");  
                     /* ResultSet rs=st.executeQuery("select addordercloth.id,addordercloth.dressname,addordercloth.price,addordercloth.status from addcategoryauction inner join addsubcategoryauction on addcategoryauction.cat=addsubcategoryauction.cat inner join addsessiondateauction on addcategoryauction.cat=addsessiondateauction.cat inner join addsessiontimeauction on addcategoryauction.cat=addsessiontimeauction.cat");
                      */
                    //while(rs.next())
          ...
          <div class="col-md-12 col-sm-12	 col-xs-12">
            <div class="single-team-member">
              <div class="team-img" style="font-size:20px;">
              <form action="addorderfabriccon" method="post">
              <div class="row">
