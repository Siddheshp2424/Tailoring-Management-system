 ...
 <div class="main">
       <div class="col-lg-12">
        <div class="canvas" id="canvas">
          <img id="person" src='assets/img/model2.jpg'/>
          <br>
          <!-- <button class="nextbuttoncanvas" id="" onclick="" >360</button> -->
         <!--  <button class="nextbuttoncanvas" id="" onclick="changeCombinations()" ><span id="combination">Try Combinatioms </span></button>
         -->  <!-- <button class="nextbuttoncanvas" id="" onclick="changeSkelton()" >Skelton</button> -->
        </div>
       </div>
...
<div>
 ...
 <%
       ...
       <a href="try.jsp?id=<%=rs.getString(1)%>"> <button class="nextbuttoncanvas">TRY</button></a>
      </div>
...
<% 
       ...
       <div class="col-4">
        <img src="assets/img/panjabi.png" class="image" alt="" />
        <h4>Dress</h4>
        <div class="rating">
          <i class="fa fa-star"></i>
          <i class="fa fa-star"></i>
        ...
        <p>$50.00</p><br>
        <a href="trydemo.jsp"><button class="nextbuttoncanvas" id="">TRY</button></a>
      </div> 
