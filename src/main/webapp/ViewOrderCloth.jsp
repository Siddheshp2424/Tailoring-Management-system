    ...
    <div id="about" class="about-area area-padding" style="background-color:#F6B6F7; height:95%;">
      <div class="container" >
       ...
       <div class="row">
                    ...
                    ResultSet rs=st.executeQuery("select * from addordercloth");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    ...
                    <td><a style="color:red;" href="DeleteOrderClothCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
