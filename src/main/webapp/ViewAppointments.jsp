              ...
              <h2>View Appointments</h2>
				...
				<div class="row">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from bookhomeappointment");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	...
                    	<th><a style="color:green;" href="UpdateViewAppointmentsCon?id=<%=rs.getInt(1)%>&status=<%=rs.getString(6)%>"><%=rs.getString(6)%></a></th>
                    	
                    	 <td><a style="color:red;" href="DeleteHomeAppointmentsCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
