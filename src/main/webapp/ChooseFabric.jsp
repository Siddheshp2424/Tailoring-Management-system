...
<div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/ac.jpg" alt=""/>            
                      <h4>Acrylic (Price:- 800)</h4>
...
<div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/ch.jpg" alt=""/>    
                      <h4>Chiffon (Price:- 500)</h4>
                       <a href="AddMeasurements.jsp">
                      <button class="btn-get-started">Choose</button>
                    </a>               
          </div>  
...
<div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/cotton.jpg" alt=""/>             
                      <h4>Cotton (Price:- 600)</h4>
                       <a href="AddMeasurements.jsp">
                      <button class="btn-get-started">Choose</button>
                    </a>               
          </div>  
 ...
 <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/cottonlinen.jpg" alt=""/>           
                      <h4>Cotton Linen (Price:- 900)</h4>
                       <a href="AddMeasurements.jsp">
                      <button class="btn-get-started">Choose</button>
                    </a>               
          </div>         
...
<div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/cottonsilk.jpg" alt=""/>          
                      <h4>Cotton Silk (Price:- 1000)</h4>
                       <a href="AddMeasurements.jsp">
                      <button class="btn-get-started">Choose</button>
                    </a>               
          </div>
 ...
 <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/crepe.jpg" alt=""/>             
                      <h4>Crepe (Price:- 600)</h4>
                       <a href="AddMeasurements.jsp">
                      <button class="btn-get-started">Choose</button>
                    </a>               
          </div>
 ...
 <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">           
                <img src="assets/img/fabric/satin.jpg" alt=""/>           
                      <h4>Satin (Price:- 850)</h4>
                       <a href="AddMeasurements.jsp">
                      <button class="btn-get-started">Choose</button>
                    </a>               
          </div>
