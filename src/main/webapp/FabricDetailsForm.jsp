...
input[type=text],input[type=time], input[type=password], input[type=date],input[id=select],select[id=fabric],select[id=citySelect],input[type=radio]{
...
  <label><b>Fabric Details:</b><br></label>
 <select name="fabric" id="fabric">
 <option value="select">Select</option>
    <option value="volvo">I have fabric</option>
    <option value="saab">I don't have fabric</option>
