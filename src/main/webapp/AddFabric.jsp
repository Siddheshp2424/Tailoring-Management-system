   ...
   <div class="col-md-3 col-sm-3 col-xs-12">
      ...
      <div class="col-md-9 col-sm-9 col-xs-12">
            <div class="pri_table_list">
             ...
             <form action="AddFabricCon" method="post" class="formone" enctype="multipart/form-data">
          <div class="row">
            <div class="form-group mt-1">
                   <input type="file" name="file" class="form-control custom-labels" /> 
               </div>
               <div class="form-group mt-1">
              <input type="text" name="fabricname" class="form-control" id="fabricname" placeholder="Enter Fabric Name" required>
            </div>
               <!-- <div class="form-group mt-1">
                   <input type="file" name="file1" class="form-control custom-labels" /> 
               </div>  
               <div class="form-group mt-1">
              <input type="text" name="fabricname1" class="form-control" id="fabricname1" placeholder="Enter Fabric Name" required>
            </div>
               <div class="form-group mt-1">
                   <input type="file" name="file2" class="form-control custom-labels" /> 
               </div>
               <div class="form-group mt-1">
              <input type="text" name="fabricname2" class="form-control" id="fabricname2" placeholder="Enter Fabric Name" required>
            </div>
               <div class="form-group mt-1">
                   <input type="file" name="file3" class="form-control custom-labels" /> 
               </div>
               <div class="form-group mt-1">
              <input type="text" name="fabricname3" class="form-control" id="fabricname3" placeholder="Enter Fabric Name" required>
            </div>
               <div class="form-group mt-1">
                   <input type="file" name="file4" class="form-control custom-labels" /> 
               </div>
               <div class="form-group mt-1">
              <input type="text" name="fabricname4" class="form-control" id="fabricname4" placeholder="Enter Fabric Name" required>
            </div>
               <div class="form-group mt-1">
                   <input type="file" name="file5" class="form-control custom-labels" /> 
               </div>
            <div class="form-group mt-1">
              <input type="text" name="fabricname5" class="form-control" id="fabricname5" placeholder="Enter Fabric Name" required>
            </div> -->
