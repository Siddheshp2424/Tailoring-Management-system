    ...
    <div id="pricing" class="pricing-area area-padding">
      <div class="container">
       ...
       <center> <div class="row">
        <div class="col-lg-6">
         <img src="assets/img/payment.jpg" alt="" width="400px" height="200px"/>
         </div>
          <div class="col-lg-5">
           
               <form action="PaymentCon" method="post" class="formone">            
              ...
              <div class="form-group mt-1">
               ...
               <div class="text-center"><button class="btn-get-started" type="submit">Place Order</button>
                  </div>                 
              </form>
