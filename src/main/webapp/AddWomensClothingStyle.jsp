 ...
 <!-- ======= Contact Section ======= -->
        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="section-headline text-center">
              <h2>Add Women's Clothing Style</h2>
            </div>
          </div>
   ...
   <div class="col-md-3 col-sm-3 col-xs-12">
      ...
      <div class="col-md-9 col-sm-9 col-xs-12">
            <div class="pri_table_list">
             <form action="AddWomensClothingStyleCon" method="post" class="formone" enctype="multipart/form-data">
          <div class="row">
            <div class="form-group mt-1">
                   <input type="file" name="file" class="form-control custom-labels" /> 
               </div>  
            <div class="form-group mt-1">
              <input type="text" name="dressname" class="form-control" id="dressname" placeholder="Enter Dress Name" required>
            </div>
            
             <div class="form-group mt-1">
              <input type="text" name="sprice" class="form-control" id="sprice" placeholder="Enter Stiching Price" required>
            </div>
