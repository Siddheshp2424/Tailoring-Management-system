      ...
      <nav id="navbar" class="navbar">
        ...
        <button onclick="history.back()" ><b>Back</b></button>
          ...
          <li><a class="nav-link scrollto" href="UserLogin.jsp">Customer</a></li>
           <li><a class="nav-link scrollto  active" href="TailorLogin.jsp">Tailor</a></li>
    ...
    <div id="pricing" class="pricing-area area-padding">
      <div class="container">
       ...
       <center> <div class="row">
        <div class="col-lg-6">
         <img src="assets/img/3.jpg" alt="" width="400px" height="200px"/>
         </div>
          <div class="col-lg-5">
           
              <form action="TailorRegistrationController" method="post" class="formone">
          <div class="row">
          ...
          <br>
       <div class="text-center"><button class="btn-get-started" type="submit">Register</button><br>
       <a href="TailorLogin.jsp" style="color:red" >Login here!!</a><br><br>
       </div>
        </form>
