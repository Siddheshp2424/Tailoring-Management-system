             ...
             <form class="subscription-form">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     Statement st=con.createStatement();
                      ...
                      ResultSet rs=st.executeQuery("select addorder.id,user.name,user.address,user.mobileno,user.email,addorder.dressname,addorder.status,addorder.statuss from addorder inner join user on addorder.email=user.email");
                     ...
                     if(rs.next() == false) {
                    	...
                    	<%-- <th><a href="UserOrderStatusController?id=<%=rs.getInt(1)%>&status=<%=rs.getString(7)%>"><%=rs.getString(7)%></a></th>   --%>                 	
                    	  <th><a href="UserStatusController?id=<%=rs.getInt(1)%>&statuss=<%=rs.getString(8)%>"><%=rs.getString(8)%></a></th>                   	
                    	 
                    	 <td><a style="color:red;" href="DeleteOrderCon?id=<%=rs.getInt(1)%>"><b>Delete</b></a></td>
                    	 </TR>                    	 
                    <%count++; }while(rs.next());}%> 
