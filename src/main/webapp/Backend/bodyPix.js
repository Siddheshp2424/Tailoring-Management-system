...
function preload() {
  imgPerson = loadImage('assets/img/model2.jpg');
  clothes = loadImage('Backend/img/suit.png');
 shirtImg = loadImage('Backend/img/suit.png');
 pantImg =  loadImage('Backend/img/halfpant.png');
 watchImg = loadImage('Backend/img/watch.png'); 
 shirtImg =  loadImage('assets/img/shirt.png');
 sungImg =  loadImage('Backend/img/sunglass.png');
}
...
function setup() {
 cnv = createCanvas(300, 585);
  ...
  clothes = loadImage('Backend/img/suit.jpg');
...
function TrailButton(key){
  console.log(key);
  if (key === 1){
    imgPerson = loadImage('Backend/img/per1.jpg');
  ...
  if (key === 2){
    shirtImg = loadImage('Backend/img/sh1.png');
  ...
  if (key === 4){
    ...
    imgPerson = loadImage('Backend/img/per1.jpg');
    pantImg = loadImage('Backend/img/halfpant1.png');
    // clothes = loadImage('img/shoes.png');
  ...
  if(combination == 0){
   ...
   if (key === 5){
    clothes = loadImage('Backend/img/a.png');
  ...
  if (key === 7){
    imgPerson = loadImage('Backend/img/per1.jpg');
    pantImg = loadImage('Backend/img/pant61.png');
    // clothes = loadImage('img/shoes.png');
  ...
  if (key === 11){
    imgPerson = loadImage('Backend/img/per1.jpg');
    //clothes = loadImage('img/suit.png'); 
    pantImg = loadImage('Backend/img/pant71.png');
  ...
  if (key === 10){
    imgPerson = loadImage('Backend/img/per1.jpg');
    //clothes = loadImage('img/suit.png'); 
    shirtImg = loadImage('Backend/img/shirt81.png');
  ...
  if (key === 9){
    imgPerson = loadImage('Backend/img/per1.jpg');
    //clothes = loadImage('img/suit.png'); 
    shirtImg = loadImage('Backend/img/shirt41.png');
